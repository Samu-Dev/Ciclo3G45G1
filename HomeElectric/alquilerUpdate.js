$(document).ready(function() {
    ...
    const url = `http://localhost:8000/alquiler/retrieve_rent/${rent_id}`
        fetch(url)
            ...
            .then(json => {
                ...
                fetch("http://localhost:8000/alquiler/retrieve_tool/"+id_tool)
                    .then(response => response.json())
                    .then(json => {
                        nomTool = json["nombre"]
    ...
    $("#update").click(function(){
        const url2 = `http://localhost:8000/alquiler/update_rent/${rent_id}`
        console.log(url2);
        id_tool = "";
        ...
        var url1 = `http://localhost:8000/alquiler/tool_name/${herramienta}`
    ...
    $("#delete").click(function(){
        ...
        const url3 = `http://localhost:8000/alquiler/delete_rent/${rent_id2}`
        console.log(url3);        
